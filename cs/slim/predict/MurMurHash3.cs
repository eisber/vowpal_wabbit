...
namespace VowpalWabbit.Prediction
{
    ...
    public static class MurMurHash3
    {
        ...
        public static ulong ComputeIdHash(byte[] keys, uint h1 = 0)
        {
            uint k1 = 0;
        ...
        public static ulong ComputeIdHash(string s, uint h1 = 0)
        {
            int sInt = 0;
            ...
            else
            {
                ...
                return ComputeIdHash(System.Text.Encoding.UTF8.GetBytes(s), h1);
            }
        }
